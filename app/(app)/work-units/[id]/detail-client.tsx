...
import { useLatestCheckpoint } from "@/lib/hooks/use-checkpoints";
...
export function DetailClient({ id }: DetailClientProps) {
  const router = useRouter();
  const { data: workUnit, isLoading: workUnitLoading } = useWorkUnit(id);
  const { data: latestCheckpoint, isLoading: checkpointLoading } = useLatestCheckpoint(id);

  if (workUnitLoading || checkpointLoading) {
    return (
